...
CREATE TABLE IF NOT EXISTS gc_events (
  email text NOT NULL,
  event_type text NOT NULL CHECK (event_type IN ('l1in','l1sent','graduates','sub_18','18_21','22_24','25_34','35_44','45_plus','sub_16','16_17','18_24')),
  imported_at timestamptz NOT NULL DEFAULT now(),
...
ALTER TABLE gc_events ADD CONSTRAINT gc_events_event_type_check CHECK (event_type IN ('l1in','l1sent','graduates','sub_18','18_21','22_24','25_34','35_44','45_plus','sub_16','16_17','18_24'));
